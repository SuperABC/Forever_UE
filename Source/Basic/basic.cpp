...
extern "C" __declspec(dllexport) void RegisterModBuildings(BuildingFactory* factory) {
	...
	factory->RegisterBuilding(AirportBuilding::GetId(),
		AirportBuilding::GetPowers(), AirportBuilding::BuildingAssigner,
		[]() { return new AirportBuilding(); },
		[](BuildingMod* building) { delete building; }
	);
}
...
extern "C" __declspec(dllexport) void* GetModVehicles() {
	static vector<string> mods = { "city", "plane" };
	return static_cast<void*>(&mods);
}

extern "C" __declspec(dllexport) void RegisterModVehicles(VehicleFactory* factory) {
	factory->RegisterVehicle(CityVehicle::GetId(), CityVehicle::GetLabel(),
		[]() { return new CityVehicle(); },
		[](VehicleMod* vehicle) { delete vehicle; }
	);
	factory->RegisterVehicle(PlaneVehicle::GetId(), PlaneVehicle::GetLabel(),
...
extern "C" __declspec(dllexport) void RegisterModApps(AppFactory* factory) {
	factory->RegisterApp(TestApp::GetId(),
		TestApp::Init,
		TestApp::Loop,
		TestApp::Back,
		TestApp::Refresh,
...
extern "C" __declspec(dllexport) void* GetModPuzzles() {
	static vector<string> mods = { "test", "tetris", "dance", "flappy", "war" };
	return static_cast<void*>(&mods);
}

extern "C" __declspec(dllexport) void RegisterModPuzzles(PuzzleFactory* factory) {
	factory->RegisterPuzzle(TestPuzzle::GetId(),
		TestPuzzle::Init,
		TestPuzzle::Loop,
		[]() { return new TestPuzzle(); },
		[](PuzzleMod* puzzle) { delete puzzle; }
	);
	factory->RegisterPuzzle(TetrisPuzzle::GetId(),
		TetrisPuzzle::Init,
		TetrisPuzzle::Loop,
		[]() { return new TetrisPuzzle(); },
		[](PuzzleMod* puzzle) { delete puzzle; }
	);
	factory->RegisterPuzzle(DancePuzzle::GetId(),
		DancePuzzle::Init,
		DancePuzzle::Loop,
		[]() { return new DancePuzzle(); },
		[](PuzzleMod* puzzle) { delete puzzle; }
	);
	factory->RegisterPuzzle(FlappyPuzzle::GetId(),
		FlappyPuzzle::Init,
		FlappyPuzzle::Loop,
		[]() { return new FlappyPuzzle(); },
		[](PuzzleMod* puzzle) { delete puzzle; }
	);
	factory->RegisterPuzzle(WarPuzzle::GetId(),
		WarPuzzle::Init,
		WarPuzzle::Loop,
