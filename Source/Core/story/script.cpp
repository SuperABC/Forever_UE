...
vector<Event*> Script::BuildEvent(JsonValue root, EventFactory* factory) const {
    ...
    for (auto obj : root) {
        ...
        if (type == "game_start") {
            ...
            if (result.IsNull()) {
                THROW_EXCEPTION(RuntimeException, "Missing result for game_success event.\n");
            }
            ...
            auto result = obj["result"];
            if (result.IsNull()) {
                THROW_EXCEPTION(RuntimeException, "Missing result for game_fail event.\n");
            }
            ...
            if (name.IsNull() || gender.IsNull()) {
                THROW_EXCEPTION(RuntimeException, "Missing name or gender for citizen_born event.\n");
            }
    ...
    for (auto obj : root) {
        ...
        if (type == "set_value") {
            ...
            if (target.IsNull() || option.IsNull()) {
                THROW_EXCEPTION(RuntimeException, "Missing target or option for add_option change.\n");
            }
            ...
            auto option = obj["option"];
            if (target.IsNull() || option.IsNull()) {
                THROW_EXCEPTION(RuntimeException, "Missing target or option for remove_option change.\n");
            }
            ...
            auto target = obj["target"];
            if (target.IsNull()) {
                THROW_EXCEPTION(RuntimeException, "Missing target for spawn_npc change.\n");
            }
            ...
            auto target = obj["target"];
            if (target.IsNull()) {
                THROW_EXCEPTION(RuntimeException, "Missing target for remove_npc change.\n");
            }
            ...
            if (target.IsNull() || destination.IsNull()) {
                THROW_EXCEPTION(RuntimeException, "Missing target or destination for npc_navigate change.\n");
            }
            ...
            auto destination = obj["destination"];
            if (target.IsNull() || destination.IsNull()) {
                THROW_EXCEPTION(RuntimeException, "Missing target or destination for teleport_citizen change.\n");
            }
