...
bool Route::AddStation(std::string connectStation, int connectSlot, Station* newStation, int newSlot, std::string name) {
...
bool Route::AddConnection(std::string connect1, int slot1, std::string connect2, int slot2) {
...
void RouteFactory::RegisterRoute(const string& id, function<Route* ()> creator) {
